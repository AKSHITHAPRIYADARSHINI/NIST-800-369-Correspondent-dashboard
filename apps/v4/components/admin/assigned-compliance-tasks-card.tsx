...
import type { MyComplianceTask } from "@/lib/mock-data/admin-compliance"
import { Button } from "@/registry/new-york-v4/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/registry/new-york-v4/ui/card"
import { Checkbox } from "@/registry/new-york-v4/ui/checkbox"

export function AssignedComplianceTasksCard({ tasks }: { tasks: MyComplianceTask[] }) {
  const [state, setState] = React.useState(tasks)

  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">My Compliance Tasks / Assigned Work</CardTitle>
      </CardHeader>
